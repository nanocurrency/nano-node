#ifndef BOOST_NETWORK_UTILS_BASE64_STANDALONE_HPP
#define BOOST_NETWORK_UTILS_BASE64_STANDALONE_HPP
...
// Implements a BASE64 converter working on an iterator range from the
// scratch.  If the input sequence does not end at the three-byte
// boundary,
// the last encoded value part is remembered in an encoding state to be
// able
// to continue with the next chunk; the BASE64 encoding processes the
// input
// by byte-triplets.
//
...
#endif  // BOOST_NETWORK_UTILS_BASE64_STANDALONE_HPP
