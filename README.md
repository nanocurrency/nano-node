...
* As of August 2018, the Nano network has processed over twelve million transactions with an unpruned ledger size of only [4.4GB](https://nano.meltingice.net/status).
