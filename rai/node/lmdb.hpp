...
public:
	...
	void timestamp_put (rai::transaction const &, rai::block_hash const &, uint64_t const &) override;
	uint64_t timestamp_get (rai::transaction const &, rai::block_hash const &) override;
	void timestamp_del (rai::transaction const &, rai::block_hash const &) override;
