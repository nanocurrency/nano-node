...
rai::mdb_val::mdb_val (rai::unchecked_info const & val_a) :
...
rai::store_iterator<rai::unchecked_key, rai::unchecked_info> rai::mdb_store::unchecked_begin (rai::transaction const & transaction_a)
{
	rai::store_iterator<rai::unchecked_key, rai::unchecked_info> result (std::make_unique<rai::mdb_iterator<rai::unchecked_key, rai::unchecked_info>> (transaction_a, unchecked));
	return result;
}

rai::store_iterator<rai::unchecked_key, rai::unchecked_info> rai::mdb_store::unchecked_begin (rai::transaction const & transaction_a, rai::unchecked_key const & key_a)
{
	rai::store_iterator<rai::unchecked_key, rai::unchecked_info> result (std::make_unique<rai::mdb_iterator<rai::unchecked_key, rai::unchecked_info>> (transaction_a, unchecked, rai::mdb_val (key_a)));
	return result;
}

rai::store_iterator<rai::unchecked_key, rai::unchecked_info> rai::mdb_store::unchecked_end ()
{
	rai::store_iterator<rai::unchecked_key, rai::unchecked_info> result (nullptr);
	return result;
}
...
void rai::mdb_store::unchecked_put (rai::transaction const & transaction_a, rai::unchecked_key const & key_a, rai::unchecked_info const & info_a)
{
	auto status (mdb_put (env.tx (transaction_a), unchecked, rai::mdb_val (key_a), rai::mdb_val (info_a), 0));
	release_assert (status == 0);
}
...
std::vector<rai::unchecked_info> rai::mdb_store::unchecked_get (rai::transaction const & transaction_a, rai::block_hash const & hash_a)
{
	std::vector<rai::unchecked_info> result;
	...
	{
		rai::unchecked_info unchecked_info (i->second);
