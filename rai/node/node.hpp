...
public:
	...
	rai::observer_set<MDB_txn *, std::shared_ptr<rai::vote>, rai::endpoint const &> vote;
...
public:
	...
	rai::vote_code vote_blocking (MDB_txn *, std::shared_ptr<rai::vote>, rai::endpoint, bool = false);
