...
rai::account rai::send_block::account () const
{
	return 0;
}
...
rai::account rai::open_block::account () const
{
	return hashables.account;
}
...
rai::account rai::change_block::account () const
{
	return 0;
}
...
rai::account rai::receive_block::account () const
{
	return 0;
}
