...
celerix::endpoint celerix::transport::map_endpoint_to_v6 (celerix::endpoint const & endpoint_a)
{
	auto endpoint_l (endpoint_a);
	if (endpoint_l.address ().is_v4 ())
	{
		endpoint_l = celerix::endpoint (boost::asio::ip::address_v6::v4_mapped (endpoint_l.address ().to_v4 ()), endpoint_l.port ());
	}
	return endpoint_l;
}

celerix::endpoint celerix::transport::map_tcp_to_endpoint (celerix::tcp_endpoint const & endpoint_a)
{
	return { endpoint_a.address (), endpoint_a.port () };
}

celerix::tcp_endpoint celerix::transport::map_endpoint_to_tcp (celerix::endpoint const & endpoint_a)
{
	return { endpoint_a.address (), endpoint_a.port () };
}

boost::asio::ip::address celerix::transport::map_address_to_subnetwork (boost::asio::ip::address address_a)
{
...
boost::asio::ip::address celerix::transport::ipv4_address_or_ipv6_subnet (boost::asio::ip::address address_a)
{
	address_a = mapped_from_v4_or_v6 (address_a);
...
bool celerix::transport::is_same_ip (boost::asio::ip::address const & address_a, boost::asio::ip::address const & address_b)
{
	return ipv4_address_or_ipv6_subnet (address_a) == ipv4_address_or_ipv6_subnet (address_b);
}

bool celerix::transport::is_same_subnetwork (boost::asio::ip::address const & address_a, boost::asio::ip::address const & address_b)
{
	return map_address_to_subnetwork (address_a) == map_address_to_subnetwork (address_b);
}

boost::asio::ip::address_v6 celerix::transport::mapped_from_v4_bytes (unsigned long address_a)
{
	return boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (address_a));
}

boost::asio::ip::address_v6 celerix::transport::mapped_from_v4_or_v6 (boost::asio::ip::address const & address_a)
{
	return address_a.is_v4 () ? boost::asio::ip::address_v6::v4_mapped (address_a.to_v4 ()) : address_a.to_v6 ();
}

bool celerix::transport::is_ipv4_or_v4_mapped_address (boost::asio::ip::address const & address_a)
{
	return address_a.is_v4 () || address_a.to_v6 ().is_v4_mapped ();
}

bool celerix::transport::reserved_address (celerix::endpoint const & endpoint_a, bool allow_local_peers)
{
...
celerix::stat::detail celerix::to_stat_detail (boost::system::error_code const & ec)
{
	switch (ec.value ())
	{
		case boost::system::errc::success:
			return celerix::stat::detail::success;
		case boost::system::errc::no_buffer_space:
			return celerix::stat::detail::no_buffer_space;
		case boost::system::errc::timed_out:
			return celerix::stat::detail::timed_out;
		case boost::system::errc::host_unreachable:
			return celerix::stat::detail::host_unreachable;
		case boost::system::errc::not_supported:
			return celerix::stat::detail::not_supported;
		default:
			return celerix::stat::detail::other;
	}
}
...
boost::asio::ip::network_v6 celerix::transport::socket_functions::get_ipv6_subnet_address (boost::asio::ip::address_v6 const & ip_address, std::size_t network_prefix)
{
	return boost::asio::ip::make_network_v6 (ip_address, static_cast<unsigned short> (network_prefix));
}

boost::asio::ip::address celerix::transport::socket_functions::first_ipv6_subnet_address (boost::asio::ip::address_v6 const & ip_address, std::size_t network_prefix)
{
...
boost::asio::ip::address celerix::transport::socket_functions::last_ipv6_subnet_address (boost::asio::ip::address_v6 const & ip_address, std::size_t network_prefix)
{
	auto range = get_ipv6_subnet_address (ip_address, network_prefix).hosts ();
	debug_assert (!range.empty ());
	return *(--range.end ());
...
std::size_t celerix::transport::socket_functions::count_subnetwork_connections (
celerix::transport::address_socket_mmap const & per_address_connections,
