...
{
public:
	transaction_impl (celerix::id_dispenser::id_t const store_id);
	virtual ~transaction_impl () = default;
	virtual void * get_handle () const = 0;

	celerix::id_dispenser::id_t const store_id;
};

class read_transaction_impl : public transaction_impl
{
public:
	explicit read_transaction_impl (celerix::id_dispenser::id_t const store_id = 0);
...
{
public:
	explicit write_transaction_impl (celerix::id_dispenser::id_t const store_id = 0);
	virtual void commit () = 0;
	virtual void renew () = 0;
	virtual bool contains (celerix::tables table_a) const = 0;
};
...
public:
	...
	virtual void * get_handle () const = 0;
	virtual celerix::id_dispenser::id_t store_id () const = 0;
...
public:
	...
	celerix::id_dispenser::id_t store_id () const override;
...
public:
	...
	bool contains (celerix::tables table_a) const;
