...
{
backend_rocksdb::backend_rocksdb (std::filesystem::path const & path, nano::rocksdb_config const & config_a, nano::logger & logger_a, nano::txn_tracking_config const & txn_tracking_config_a) :
	database_path{ path },
	config{ config_a }
{
