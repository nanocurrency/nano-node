...
public:
	...
	[[nodiscard]] bool wallet_locked_impl (nano::transaction const &, std::shared_ptr<nano::wallet> const &);
	[[nodiscard]] bool wallet_account_impl (nano::transaction const &, std::shared_ptr<nano::wallet> const &, nano::account const &);
