...
state_block_signature_verification (node.checker, node.ledger.constants.ledger.epochs, node.config, node.logger, node.config.flags.block_processor_verification_size)
{
