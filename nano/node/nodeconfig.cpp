...
nano::error nano::node_config::serialize_toml (nano::tomlconfig & toml) const
{
	...
	toml.put ("bootstrap_attempts_max", bootstrap_attempts_max, "Maximum number of concurrent bootstrap attempts. Defaults to 2.\nWarning: a larger amount of attempts may use additional system memory.\ntype:uint64");
...
nano::error nano::node_config::deserialize_toml (nano::tomlconfig & toml)
{
	try
	{
		...
		toml.get<unsigned> ("bootstrap_attempts_max", bootstrap_attempts_max);
