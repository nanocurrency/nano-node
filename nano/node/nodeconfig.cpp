...
nano::error nano::node_config::serialize_toml (nano::tomlconfig & toml) const
{
	...
	toml.put ("request_aggregator_threads", request_aggregator_threads, "Number of threads dedicated to the request aggregator. Defaults to half the number of CPU threads, and at least 2.");
