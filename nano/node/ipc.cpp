...
using ipc_json_handler_no_arg_func_map = std::unordered_map<std::string, std::function<void(nano::ipc_json_handler *)>>;
...
public:
	...
	void handle_json_query ()
	{
		...
		// Note that if the rpc action is async, the shared_ptr<ipc_json_handler> lifetime will be extended by the action handler
		auto handler (std::make_shared<nano::ipc_json_handler> (server, node, body, request_id_l, response_handler_l));
...
void nano::ipc::ipc_server::add_block_observer ()
{
...
void nano::ipc::ipc_server::observer_action (nano::account const & account_a)
{
...
void nano::ipc_json_handler::process_request ()
{
	try
	{
...
nano::ipc_json_handler::ipc_json_handler (nano::ipc::ipc_server & ipc_server_a, nano::node & node_a, std::string const & body_a, std::string const & request_id_a, std::function<void(boost::property_tree::ptree const &)> const & response_a) :
body (body_a),
...
void nano::ipc_json_handler::response_errors ()
{
...
std::shared_ptr<nano::wallet> nano::ipc_json_handler::wallet_impl ()
{
	if (!ec)
	{
...
bool nano::ipc_json_handler::wallet_locked_impl (nano::transaction const & transaction_a, std::shared_ptr<nano::wallet> wallet_a)
{
	bool result (false);
	if (!ec)
	{
...
bool nano::ipc_json_handler::wallet_account_impl (nano::transaction const & transaction_a, std::shared_ptr<nano::wallet> wallet_a, nano::account const & account_a)
{
	bool result (false);
	if (!ec)
	{
...
nano::account nano::ipc_json_handler::account_impl (std::string account_text)
{
...
nano::amount nano::ipc_json_handler::amount_impl ()
{
...
std::shared_ptr<nano::block> nano::ipc_json_handler::block_impl (bool signature_work_required)
{
...
std::shared_ptr<nano::block> nano::ipc_json_handler::block_json_impl (bool signature_work_required)
{
	std::shared_ptr<nano::block> result;
	if (!ec)
	{
...
nano::block_hash nano::ipc_json_handler::hash_impl (std::string search_text)
{
...
nano::amount nano::ipc_json_handler::threshold_optional_impl ()
{
	nano::amount result (0);
...
uint64_t nano::ipc_json_handler::work_optional_impl ()
{
	uint64_t result (0);
...
uint64_t nano::ipc_json_handler::count_impl ()
{
	uint64_t result (0);
	if (!ec)
	{
...
uint64_t nano::ipc_json_handler::count_optional_impl (uint64_t result)
{
...
uint64_t nano::ipc_json_handler::offset_optional_impl (uint64_t result)
{
...
void nano::ipc_json_handler::account_balance ()
{
...
void nano::ipc_json_handler::account_block_count ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_create ()
{
...
void nano::ipc_json_handler::account_get ()
{
...
void nano::ipc_json_handler::account_info ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_key ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_list ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_move ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_remove ()
{
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	if (!ec)
...
void nano::ipc_json_handler::account_representative ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::account_representative_set ()
{
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	if (!ec)
...
void nano::ipc_json_handler::account_weight ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::accounts_balances ()
{
...
void nano::ipc_json_handler::accounts_create ()
{
	auto wallet (wallet_impl ());
...
void nano::ipc_json_handler::accounts_frontiers ()
{
...
void nano::ipc_json_handler::accounts_pending ()
{
...
void nano::ipc_json_handler::block_info ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::block_confirm ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::blocks ()
{
...
void nano::ipc_json_handler::blocks_info ()
{
	const bool pending = request.get<bool> ("pending", false);
	const bool source = request.get<bool> ("source", false);
	const bool json_block_l = request.get<bool> ("json_block", false);
...
void nano::ipc_json_handler::block_account ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::block_count ()
{
	auto transaction (node.store.tx_begin_read ());
...
void nano::ipc_json_handler::block_count_type ()
{
	auto transaction (node.store.tx_begin_read ());
...
void nano::ipc_json_handler::block_create ()
{
	if (!ec)
	{
...
void nano::ipc_json_handler::block_hash ()
{
	const bool json_block_l = request.get<bool> ("json_block", false);
...
void nano::ipc_json_handler::bootstrap ()
{
...
void nano::ipc_json_handler::bootstrap_any ()
{
...
void nano::ipc_json_handler::bootstrap_lazy ()
{
	auto hash (hash_impl ());
 ...
 */
void nano::ipc_json_handler::bootstrap_status ()
{
...
void nano::ipc_json_handler::chain (bool successors)
{
...
void nano::ipc_json_handler::confirmation_active ()
{
...
void nano::ipc_json_handler::confirmation_history ()
{
	boost::property_tree::ptree elections;
...
void nano::ipc_json_handler::confirmation_info ()
{
...
void nano::ipc_json_handler::confirmation_quorum ()
{
...
void nano::ipc_json_handler::delegators ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::delegators_count ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::deterministic_key ()
{
...
void nano::ipc_json_handler::frontiers ()
{
...
void nano::ipc_json_handler::account_count ()
{
	auto transaction (node.store.tx_begin_read ());
...
{
public:
	history_visitor (nano::ipc_json_handler & handler_a, bool raw_a, nano::transaction & transaction_a, boost::property_tree::ptree & tree_a, nano::block_hash const & hash_a, std::vector<nano::public_key> const & accounts_filter_a = {}) :
	handler (handler_a),
	raw (raw_a),
...
void nano::ipc_json_handler::account_history ()
{
...
void nano::ipc_json_handler::keepalive ()
{
	if (!ec)
	{
		std::string address_text (request.get<std::string> ("address"));
...
void nano::ipc_json_handler::key_create ()
{
	nano::keypair pair;
...
void nano::ipc_json_handler::key_expand ()
{
	std::string key_text (request.get<std::string> ("key"));
	nano::uint256_union prv;
...
void nano::ipc_json_handler::ledger ()
{
	auto count (count_optional_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::mnano_from_raw (nano::uint128_t ratio)
{
...
void nano::ipc_json_handler::mnano_to_raw (nano::uint128_t ratio)
{
	auto amount (amount_impl ());
	if (!ec)
	{
 ...
 * @warning This is an internal/diagnostic RPC, do not rely on its interface being stable
 */
void nano::ipc_json_handler::node_id ()
{
	if (!ec)
	{
 ...
 * @warning This is an internal/diagnostic RPC, do not rely on its interface being stable
 */
void nano::ipc_json_handler::node_id_delete ()
{
	if (!ec)
	{
...
void nano::ipc_json_handler::password_change ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::password_enter ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::password_valid (bool wallet_locked)
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::peers ()
{
	boost::property_tree::ptree peers_l;
...
void nano::ipc_json_handler::pending ()
{
	auto account (account_impl ());
	auto count (count_optional_impl ());
	auto threshold (threshold_optional_impl ());
...
void nano::ipc_json_handler::pending_exists ()
{
	auto hash (hash_impl ());
	const bool include_active = request.get<bool> ("include_active", false);
	if (!ec)
...
void nano::ipc_json_handler::payment_begin ()
{
...
void nano::ipc_json_handler::payment_init ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::payment_end ()
{
	auto account (account_impl ());
	auto wallet (wallet_impl ());
	if (!ec)
...
void nano::ipc_json_handler::payment_wait ()
{
	...
	if (!ec)
	{
		...
		{
			{
				auto observer (std::make_shared<nano::payment_observer> (node, ipc_server, response, account, amount));
				observer->start (timeout);

				std::lock_guard<std::mutex> lock (ipc_server.mutex);
				assert (ipc_server.payment_observers.find (account) == ipc_server.payment_observers.end ());
				ipc_server.payment_observers[account] = observer;
			}
			ipc_server.observer_action (account);
		}
		else
		{
...
void nano::ipc_json_handler::process ()
{
	const bool json_block_l = request.get<bool> ("json_block", false);
	std::shared_ptr<nano::block> block;
	if (json_block_l)
...
void nano::ipc_json_handler::receive ()
{
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	auto hash (hash_impl ("block"));
...
void nano::ipc_json_handler::receive_minimum ()
{
	if (!ec)
	{
...
void nano::ipc_json_handler::receive_minimum_set ()
{
	auto amount (amount_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::representatives ()
{
	auto count (count_optional_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::representatives_online ()
{
...
void nano::ipc_json_handler::republish ()
{
...
void nano::ipc_json_handler::search_pending ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::search_pending_all ()
{
	if (!ec)
	{
...
void nano::ipc_json_handler::send ()
{
	auto wallet (wallet_impl ());
	auto amount (amount_impl ());
...
void nano::ipc_json_handler::sign ()
{
	const bool json_block_l = request.get<bool> ("json_block", false);
	// Retrieving hash
	nano::block_hash hash (0);
...
void nano::ipc_json_handler::stats ()
{
...
void nano::ipc_json_handler::stats_clear ()
{
	node.stats.clear ();
	response_l.put ("success", "");
	response (response_l);
...
void nano::ipc_json_handler::stop ()
{
	response_l.put ("success", "");
	response_errors ();
	if (!ec)
...
void nano::ipc_json_handler::unchecked ()
{
	auto count (count_optional_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::unchecked_clear ()
{
	auto transaction (node.store.tx_begin_write ());
...
void nano::ipc_json_handler::unchecked_get ()
{
	const bool json_block_l = request.get<bool> ("json_block", false);
	auto hash (hash_impl ());
	if (!ec)
...
void nano::ipc_json_handler::unchecked_keys ()
{
	const bool json_block_l = request.get<bool> ("json_block", false);
	auto count (count_optional_impl ());
...
void nano::ipc_json_handler::unopened ()
{
	auto count (count_optional_impl ());
...
void nano::ipc_json_handler::validate_account_number ()
{
...
void nano::ipc_json_handler::wallet_add ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_add_watch ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_info ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_balances ()
{
	auto wallet (wallet_impl ());
	auto threshold (threshold_optional_impl ());
	if (!ec)
...
void nano::ipc_json_handler::wallet_change_seed ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_contains ()
{
	auto account (account_impl ());
	auto wallet (wallet_impl ());
	if (!ec)
...
void nano::ipc_json_handler::wallet_create ()
{
	nano::raw_key seed;
...
void nano::ipc_json_handler::wallet_destroy ()
{
	std::string wallet_text (request.get<std::string> ("wallet"));
	nano::uint256_union wallet;
	if (!wallet.decode_hex (wallet_text))
...
void nano::ipc_json_handler::wallet_export ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_frontiers ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_history ()
{
...
void nano::ipc_json_handler::wallet_key_valid ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_ledger ()
{
	const bool representative = request.get<bool> ("representative", false);
	const bool weight = request.get<bool> ("weight", false);
	const bool pending = request.get<bool> ("pending", false);
...
void nano::ipc_json_handler::wallet_lock ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_pending ()
{
	auto wallet (wallet_impl ());
	auto count (count_optional_impl ());
	auto threshold (threshold_optional_impl ());
...
void nano::ipc_json_handler::wallet_representative ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_representative_set ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::wallet_republish ()
{
	auto wallet (wallet_impl ());
	auto count (count_impl ());
	if (!ec)
...
void nano::ipc_json_handler::wallet_work_get ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::work_cancel ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void nano::ipc_json_handler::work_get ()
{
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	if (!ec)
...
void nano::ipc_json_handler::work_set ()
{
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	auto work (work_optional_impl ());
...
void nano::ipc_json_handler::work_validate ()
{
	auto hash (hash_impl ());
	auto work (work_optional_impl ());
	uint64_t difficulty (node.network_params.network.publish_threshold);
...
void nano::ipc_json_handler::work_peer_add ()
{
	std::string address_text = request.get<std::string> ("address");
	std::string port_text = request.get<std::string> ("port");
	uint16_t port;
...
void nano::ipc_json_handler::work_peers ()
{
...
void nano::ipc_json_handler::work_peers_clear ()
{
...
nano::payment_observer::payment_observer (nano::node & node_a, nano::ipc::ipc_server & ipc_server_a, std::function<void(boost::property_tree::ptree const &)> const & response_a, nano::account const & account_a, nano::amount const & amount_a) :
node (node_a),
account (account_a),
amount (amount_a),
response (response_a),
...
void nano::payment_observer::complete (nano::payment_status status)
{
	...
	if (!already)
	{
		if (node.config.logging.log_ipc ())
		{
			node.logger.always_log (boost::str (boost::format ("Exiting payment_observer for account %1% status %2%") % account.to_account () % static_cast<unsigned> (status)));
		}
		switch (status)
		{
...
ipc_json_handler_no_arg_func_map create_ipc_json_handler_no_arg_func_map ()
{
	...
	no_arg_funcs.emplace ("account_balance", &nano::ipc_json_handler::account_balance);
	no_arg_funcs.emplace ("account_block_count", &nano::ipc_json_handler::account_block_count);
	no_arg_funcs.emplace ("account_count", &nano::ipc_json_handler::account_count);
	no_arg_funcs.emplace ("account_create", &nano::ipc_json_handler::account_create);
	no_arg_funcs.emplace ("account_get", &nano::ipc_json_handler::account_get);
	no_arg_funcs.emplace ("account_history", &nano::ipc_json_handler::account_history);
	no_arg_funcs.emplace ("account_info", &nano::ipc_json_handler::account_info);
	no_arg_funcs.emplace ("account_key", &nano::ipc_json_handler::account_key);
	no_arg_funcs.emplace ("account_list", &nano::ipc_json_handler::account_list);
	no_arg_funcs.emplace ("account_move", &nano::ipc_json_handler::account_move);
	no_arg_funcs.emplace ("account_remove", &nano::ipc_json_handler::account_remove);
	no_arg_funcs.emplace ("account_representative", &nano::ipc_json_handler::account_representative);
	no_arg_funcs.emplace ("account_representative_set", &nano::ipc_json_handler::account_representative_set);
	no_arg_funcs.emplace ("account_weight", &nano::ipc_json_handler::account_weight);
	no_arg_funcs.emplace ("accounts_balances", &nano::ipc_json_handler::accounts_balances);
	no_arg_funcs.emplace ("accounts_create", &nano::ipc_json_handler::accounts_create);
	no_arg_funcs.emplace ("accounts_frontiers", &nano::ipc_json_handler::accounts_frontiers);
	no_arg_funcs.emplace ("accounts_pending", &nano::ipc_json_handler::accounts_pending);
	no_arg_funcs.emplace ("available_supply", &nano::ipc_json_handler::available_supply);
	no_arg_funcs.emplace ("block_info", &nano::ipc_json_handler::block_info);
	no_arg_funcs.emplace ("block", &nano::ipc_json_handler::block_info);
	no_arg_funcs.emplace ("block_confirm", &nano::ipc_json_handler::block_confirm);
	no_arg_funcs.emplace ("blocks", &nano::ipc_json_handler::blocks);
	no_arg_funcs.emplace ("blocks_info", &nano::ipc_json_handler::blocks_info);
	no_arg_funcs.emplace ("block_account", &nano::ipc_json_handler::block_account);
	no_arg_funcs.emplace ("block_count", &nano::ipc_json_handler::block_count);
	no_arg_funcs.emplace ("block_count_type", &nano::ipc_json_handler::block_count_type);
	no_arg_funcs.emplace ("block_create", &nano::ipc_json_handler::block_create);
	no_arg_funcs.emplace ("block_hash", &nano::ipc_json_handler::block_hash);
	no_arg_funcs.emplace ("bootstrap", &nano::ipc_json_handler::bootstrap);
	no_arg_funcs.emplace ("bootstrap_any", &nano::ipc_json_handler::bootstrap_any);
	no_arg_funcs.emplace ("bootstrap_lazy", &nano::ipc_json_handler::bootstrap_lazy);
	no_arg_funcs.emplace ("bootstrap_status", &nano::ipc_json_handler::bootstrap_status);
	no_arg_funcs.emplace ("delegators", &nano::ipc_json_handler::delegators);
	no_arg_funcs.emplace ("delegators_count", &nano::ipc_json_handler::delegators_count);
	no_arg_funcs.emplace ("deterministic_key", &nano::ipc_json_handler::deterministic_key);
	no_arg_funcs.emplace ("confirmation_active", &nano::ipc_json_handler::confirmation_active);
	no_arg_funcs.emplace ("confirmation_history", &nano::ipc_json_handler::confirmation_history);
	no_arg_funcs.emplace ("confirmation_info", &nano::ipc_json_handler::confirmation_info);
	no_arg_funcs.emplace ("confirmation_quorum", &nano::ipc_json_handler::confirmation_quorum);
	no_arg_funcs.emplace ("frontiers", &nano::ipc_json_handler::frontiers);
	no_arg_funcs.emplace ("frontier_count", &nano::ipc_json_handler::account_count);
	no_arg_funcs.emplace ("keepalive", &nano::ipc_json_handler::keepalive);
	no_arg_funcs.emplace ("key_create", &nano::ipc_json_handler::key_create);
	no_arg_funcs.emplace ("key_expand", &nano::ipc_json_handler::key_expand);
	no_arg_funcs.emplace ("ledger", &nano::ipc_json_handler::ledger);
	no_arg_funcs.emplace ("node_id", &nano::ipc_json_handler::node_id);
	no_arg_funcs.emplace ("node_id_delete", &nano::ipc_json_handler::node_id_delete);
	no_arg_funcs.emplace ("password_change", &nano::ipc_json_handler::password_change);
	no_arg_funcs.emplace ("password_enter", &nano::ipc_json_handler::password_enter);
	no_arg_funcs.emplace ("wallet_unlock", &nano::ipc_json_handler::password_enter);
	no_arg_funcs.emplace ("payment_begin", &nano::ipc_json_handler::payment_begin);
	no_arg_funcs.emplace ("payment_init", &nano::ipc_json_handler::payment_init);
	no_arg_funcs.emplace ("payment_end", &nano::ipc_json_handler::payment_end);
	no_arg_funcs.emplace ("payment_wait", &nano::ipc_json_handler::payment_wait);
	no_arg_funcs.emplace ("peers", &nano::ipc_json_handler::peers);
	no_arg_funcs.emplace ("pending", &nano::ipc_json_handler::pending);
	no_arg_funcs.emplace ("pending_exists", &nano::ipc_json_handler::pending_exists);
	no_arg_funcs.emplace ("process", &nano::ipc_json_handler::process);
	no_arg_funcs.emplace ("receive", &nano::ipc_json_handler::receive);
	no_arg_funcs.emplace ("receive_minimum", &nano::ipc_json_handler::receive_minimum);
	no_arg_funcs.emplace ("receive_minimum_set", &nano::ipc_json_handler::receive_minimum_set);
	no_arg_funcs.emplace ("representatives", &nano::ipc_json_handler::representatives);
	no_arg_funcs.emplace ("representatives_online", &nano::ipc_json_handler::representatives_online);
	no_arg_funcs.emplace ("republish", &nano::ipc_json_handler::republish);
	no_arg_funcs.emplace ("search_pending", &nano::ipc_json_handler::search_pending);
	no_arg_funcs.emplace ("search_pending_all", &nano::ipc_json_handler::search_pending_all);
	no_arg_funcs.emplace ("send", &nano::ipc_json_handler::send);
	no_arg_funcs.emplace ("sign", &nano::ipc_json_handler::sign);
	no_arg_funcs.emplace ("stats", &nano::ipc_json_handler::stats);
	no_arg_funcs.emplace ("stats_clear", &nano::ipc_json_handler::stats_clear);
	no_arg_funcs.emplace ("stop", &nano::ipc_json_handler::stop);
	no_arg_funcs.emplace ("unchecked", &nano::ipc_json_handler::unchecked);
	no_arg_funcs.emplace ("unchecked_clear", &nano::ipc_json_handler::unchecked_clear);
	no_arg_funcs.emplace ("unchecked_get", &nano::ipc_json_handler::unchecked_get);
	no_arg_funcs.emplace ("unchecked_keys", &nano::ipc_json_handler::unchecked_keys);
	no_arg_funcs.emplace ("unopened", &nano::ipc_json_handler::unopened);
	no_arg_funcs.emplace ("uptime", &nano::ipc_json_handler::uptime);
	no_arg_funcs.emplace ("validate_account_number", &nano::ipc_json_handler::validate_account_number);
	no_arg_funcs.emplace ("version", &nano::ipc_json_handler::version);
	no_arg_funcs.emplace ("wallet_add", &nano::ipc_json_handler::wallet_add);
	no_arg_funcs.emplace ("wallet_add_watch", &nano::ipc_json_handler::wallet_add_watch);
	no_arg_funcs.emplace ("wallet_balances", &nano::ipc_json_handler::wallet_balances);
	no_arg_funcs.emplace ("wallet_change_seed", &nano::ipc_json_handler::wallet_change_seed);
	no_arg_funcs.emplace ("wallet_contains", &nano::ipc_json_handler::wallet_contains);
	no_arg_funcs.emplace ("wallet_create", &nano::ipc_json_handler::wallet_create);
	no_arg_funcs.emplace ("wallet_destroy", &nano::ipc_json_handler::wallet_destroy);
	no_arg_funcs.emplace ("wallet_export", &nano::ipc_json_handler::wallet_export);
	no_arg_funcs.emplace ("wallet_frontiers", &nano::ipc_json_handler::wallet_frontiers);
	no_arg_funcs.emplace ("wallet_history", &nano::ipc_json_handler::wallet_history);
	no_arg_funcs.emplace ("wallet_info", &nano::ipc_json_handler::wallet_info);
	no_arg_funcs.emplace ("wallet_balance_total", &nano::ipc_json_handler::wallet_info);
	no_arg_funcs.emplace ("wallet_key_valid", &nano::ipc_json_handler::wallet_key_valid);
	no_arg_funcs.emplace ("wallet_ledger", &nano::ipc_json_handler::wallet_ledger);
	no_arg_funcs.emplace ("wallet_lock", &nano::ipc_json_handler::wallet_lock);
	no_arg_funcs.emplace ("wallet_pending", &nano::ipc_json_handler::wallet_pending);
	no_arg_funcs.emplace ("wallet_representative", &nano::ipc_json_handler::wallet_representative);
	no_arg_funcs.emplace ("wallet_representative_set", &nano::ipc_json_handler::wallet_representative_set);
	no_arg_funcs.emplace ("wallet_republish", &nano::ipc_json_handler::wallet_republish);
	no_arg_funcs.emplace ("wallet_work_get", &nano::ipc_json_handler::wallet_work_get);
	no_arg_funcs.emplace ("work_generate", &nano::ipc_json_handler::work_generate);
	no_arg_funcs.emplace ("work_cancel", &nano::ipc_json_handler::work_cancel);
	no_arg_funcs.emplace ("work_get", &nano::ipc_json_handler::work_get);
	no_arg_funcs.emplace ("work_set", &nano::ipc_json_handler::work_set);
	no_arg_funcs.emplace ("work_validate", &nano::ipc_json_handler::work_validate);
	no_arg_funcs.emplace ("work_peer_add", &nano::ipc_json_handler::work_peer_add);
	no_arg_funcs.emplace ("work_peers", &nano::ipc_json_handler::work_peers);
	no_arg_funcs.emplace ("work_peers_clear", &nano::ipc_json_handler::work_peers_clear);
	return no_arg_funcs;
}
}
