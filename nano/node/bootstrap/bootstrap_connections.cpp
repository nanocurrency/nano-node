...
std::shared_ptr<nano::bootstrap_client> nano::bootstrap_connections::connection (nano::unique_lock<std::mutex> & lock_a, std::shared_ptr<nano::bootstrap_attempt> attempt_a, bool use_front_connection)
{
	lock_a.unlock ();
