#include "nano/lib/asio.hpp" // for shared_cons...
#include "nano/lib/logger_mt.hpp" // for logger_mt
#include "nano/lib/stats.hpp" // for stat, stat:...
#include "nano/lib/threading.hpp" // for thread_pool
#include "nano/lib/work.hpp" // for work_valida...
#include "nano/node/blockprocessor.hpp" // for block_proce...
#include "nano/node/bootstrap/bootstrap.hpp" // for bootstrap_i...
#include "nano/node/bootstrap/bootstrap_connections.hpp" // for bootstrap_c...
#include "nano/node/bootstrap/bootstrap_server.hpp" // for bootstrap_s...
#include "nano/node/common.hpp" // for bulk_push
#include "nano/node/logging.hpp" // for logging
#include "nano/node/nodeconfig.hpp" // for node_config
#include "nano/node/socket.hpp" // for socket, buf...
#include "nano/secure/buffer.hpp" // for bufferstream
#include "nano/secure/common.hpp" // for network_params

#include <nano/node/bootstrap/bootstrap_attempt.hpp> // for bootstrap_a...
...
#include <boost/format/alt_sstream_impl.hpp> // for basic_altst...
#include <boost/format/exceptions.hpp>
#include <boost/format/format_class.hpp> // for basic_format
#include <boost/format/format_fwd.hpp> // for format
#include <boost/format/format_implementation.hpp> // for basic_forma...
