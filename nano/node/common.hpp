...
public:
	...
	message_parser (nano::unique_factory<nano::block> &, nano::unique_factory<nano::vote> &, nano::message_visitor &, nano::work_pool &);
...
{
public:
	publish (bool &, nano::stream &, nano::message_header const &, nano::unique_factory<nano::block> * = nullptr);
...
{
public:
	confirm_req (bool &, nano::stream &, nano::message_header const &, nano::unique_factory<nano::block> * = nullptr);
