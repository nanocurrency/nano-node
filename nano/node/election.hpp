...
class election final : public std::enable_shared_from_this<nano::election>
{
	...
	std::function<void(nano::account)> live_vote_action;
...
public: // Interface
	election (nano::node &, std::shared_ptr<nano::block>, std::function<void(std::shared_ptr<nano::block>)> const &, std::function<void(nano::account const &)> const &, bool, nano::election_behavior);
