...
void nano::wallet_store::insert_watch (nano::transaction const & transaction_a, nano::account const & pub)
{
	entry_put_raw (transaction_a, pub, nano::wallet_value (nano::private_key (0), 0));
}
