...
nano::error nano::diagnostics_config::serialize_toml (nano::tomlconfig & toml) const
{
	...
	txn_tracking_l.put ("enable", txn_tracking.enable, "Enable or disable database transactions.\ntype:bool");
	txn_tracking_l.put ("min_read_txn_time", txn_tracking.min_read_txn_time.count (), "Logs stacktrace when read transactions are held longer than this time.\ntype:milliseconds");
	txn_tracking_l.put ("min_write_txn_time", txn_tracking.min_write_txn_time.count (), "Logs stacktrace when write transactions are held longer than this time.\ntype:milliseconds");
	txn_tracking_l.put ("ignore_writes_below_block_processor_max_time", txn_tracking.ignore_writes_below_block_processor_max_time, "Ignore any block processor writes less than block_processor_max_time.\ntype:bool");
