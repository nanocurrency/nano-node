...
public:
	...
	void work_generate (nano::root const &, std::function<void(boost::optional<uint64_t>)>, uint64_t);
	void work_generate (nano::root const &, std::function<void(boost::optional<uint64_t>)>);
