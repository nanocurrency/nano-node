...
public:
	...
	[[nodiscard]] bool local_work_generation_enabled () const;
	[[nodiscard]] bool work_generation_enabled () const;
	[[nodiscard]] bool work_generation_enabled (std::vector<std::pair<std::string, uint16_t>> const &) const;
	...
	[[nodiscard]] bool block_confirmed (nano::block_hash const &);
	[[nodiscard]] bool block_confirmed_or_being_confirmed (nano::transaction const &, nano::block_hash const &);
	...
	[[nodiscard]] bool init_error () const;
