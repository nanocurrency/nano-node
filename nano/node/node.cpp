...
{
	work_generate (root_a, callback_a, network_params.network.publish_threshold);
}

void nano::node::work_generate (nano::root const & root_a, std::function<void(boost::optional<uint64_t>)> callback_a, uint64_t difficulty_a)
{
	distributed_work.make (root_a, callback_a, difficulty_a);
}
