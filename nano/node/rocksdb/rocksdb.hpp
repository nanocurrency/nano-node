...
{
public:
	rocksdb_store (nano::logger_mt &, boost::filesystem::path const &, nano::rocksdb_config const & = nano::rocksdb_config{}, bool open_read_only = false, bool pruning_a = false);
...
private:
	...
	void open (bool & error_a, boost::filesystem::path const & path_a, bool open_read_only_a, bool pruning_a);
