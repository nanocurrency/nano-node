...
public:
	...
	[[nodiscard]] bool ledger_logging () const;
	[[nodiscard]]  bool ledger_duplicate_logging () const;
	[[nodiscard]]  bool ledger_rollback_logging () const;
	[[nodiscard]]  bool vote_logging () const;
	[[nodiscard]]  bool election_fork_tally_logging () const;
	[[nodiscard]]  bool election_expiration_tally_logging () const;
	[[nodiscard]]  bool network_logging () const;
	[[nodiscard]]  bool network_timeout_logging () const;
	[[nodiscard]]  bool network_message_logging () const;
	[[nodiscard]]  bool network_publish_logging () const;
	[[nodiscard]]  bool network_packet_logging () const;
	[[nodiscard]]  bool network_keepalive_logging () const;
	[[nodiscard]]  bool network_node_id_handshake_logging () const;
	[[nodiscard]]  bool network_telemetry_logging () const;
	[[nodiscard]]  bool network_rejected_logging () const;
	[[nodiscard]]  bool node_lifetime_tracing () const;
	[[nodiscard]]  bool insufficient_work_logging () const;
	[[nodiscard]]  bool upnp_details_logging () const;
	[[nodiscard]]  bool timing_logging () const;
	[[nodiscard]]  bool log_ipc () const;
	[[nodiscard]]  bool bulk_pull_logging () const;
	[[nodiscard]]  bool callback_logging () const;
	[[nodiscard]]  bool work_generation_time () const;
	[[nodiscard]]  bool active_update_logging () const;
	[[nodiscard]]  bool log_to_cerr () const;
	[[nodiscard]]  bool single_line_record () const;
