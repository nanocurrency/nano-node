...
celerix::error celerix::rocksdb_config::serialize_toml (celerix::tomlconfig & toml) const
{
...
celerix::error celerix::rocksdb_config::deserialize_toml (celerix::tomlconfig & toml)
{
...
bool celerix::rocksdb_config::using_rocksdb_in_tests ()
{
