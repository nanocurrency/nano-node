...
#ifndef NDEBUG
#define nano_debug                                                                                                                                            \
	(levelName, ostreamInput)                                                                                                                                 \
	{                                                                                                                                                         \
		nano::debug::internal (nano::debug::subsystem::NANO_DEBUG_SUBSYSTEM, nano::debug::level::levelName, __func__, __LINE__) << ostreamInput << std::endl; \
	}
#else
