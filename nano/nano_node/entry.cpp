...
int main (int argc, char * const * argv)
{
	...
	description.add_options ()
		...
		("pow_sleep_interval", boost::program_options::value<std::string> (), "Defines the amount to sleep between each pow calculation attempt")
	...
	if (ec == nano::error_cli::unknown_command)
	{
		...
		{
			if (nano::get_active_network () != nano::network_type::nano_dev_network)
			{
