...
public:
	...
	virtual void latest_for_each_par (nano::read_transaction const &, std::function<void(nano::store_iterator<nano::account, nano::account_info>, nano::store_iterator<nano::account, nano::account_info>)>) = 0;
	virtual void confirmation_height_for_each_par (nano::read_transaction const &, std::function<void(nano::store_iterator<nano::account, nano::confirmation_height_info>, nano::store_iterator<nano::account, nano::confirmation_height_info>)>) = 0;
