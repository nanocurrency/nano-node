...
public:
	...
	virtual nano::unchecked_info unchecked_hash_get (nano::transaction const &, nano::block_hash const &) = 0;
	virtual bool unchecked_exists (nano::transaction const &, nano::unchecked_key const &) = 0;
	virtual bool unchecked_hash_exists (nano::transaction const &, nano::block_hash const &) = 0;
