...
public:
	...
	void block_raw_put (nano::write_transaction const & transaction_a, std::vector<uint8_t> const & data, nano::block_hash const & hash_a, nano::store_hint store_hint_a)
	{
...
public:
	...
	void fill_value (nano::block const & block_a)
	{
		...
		store.block_raw_put (transaction, data, block_a.previous (), store_hint::key_exists);
	}
