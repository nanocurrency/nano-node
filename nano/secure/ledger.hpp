...
public:
	...
	[[nodiscard]] bool block_confirmed (nano::transaction const & transaction_a, nano::block_hash const & hash_a) const;
	...
	[[nodiscard]] bool is_send (nano::transaction const &, nano::state_block const &) const;
	...
	[[nodiscard]] bool could_fit (nano::transaction const &, nano::block const &) const;
	[[nodiscard]] bool dependents_confirmed (nano::transaction const &, nano::block const &) const;
	[[nodiscard]] bool is_epoch_link (nano::link const &) const;
