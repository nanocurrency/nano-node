...
std::filesystem::path working_path (nano::networks network = nano::get_active_network ());
...
std::filesystem::path unique_path (nano::networks network = nano::get_active_network ());
