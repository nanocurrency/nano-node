...
TEST (confirmation_solicitor, bypass_max_requests_cap)
{
	...
	ASSERT_TRUE (election2->solicitor_add (solicitor));
	ASSERT_TRUE (election2->solicitor_broadcast (solicitor));
