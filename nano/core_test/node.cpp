...
TEST (node, DISABLED_bootstrap_connection_scaling)
{
	...
	ASSERT_EQ (64, node1.bootstrap_initiator.connections->target_connections (0));
	ASSERT_EQ (64, node1.bootstrap_initiator.connections->target_connections (50000));
	node1.config.bootstrap_connections_max = 256;
	ASSERT_EQ (128, node1.bootstrap_initiator.connections->target_connections (0));
	ASSERT_EQ (256, node1.bootstrap_initiator.connections->target_connections (50000));
	node1.config.bootstrap_connections_max = 0;
	ASSERT_EQ (1, node1.bootstrap_initiator.connections->target_connections (0));
	ASSERT_EQ (1, node1.bootstrap_initiator.connections->target_connections (50000));
}
