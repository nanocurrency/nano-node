...
TEST (toml, daemon_config_deserialize_defaults)
{
	...
	ASSERT_EQ (conf.node.bootstrap_attempts_max, defaults.node.bootstrap_attempts_max);
...
TEST (toml, daemon_config_deserialize_no_defaults)
{
	...
	ASSERT_NE (conf.node.bootstrap_attempts_max, defaults.node.bootstrap_attempts_max);
