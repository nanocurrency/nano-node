...
TEST (active_transactions, update_difficulty)
{
	...
	auto work1 = node1.work_generate_blocking (genesis.hash (), difficulty1 + 1, boost::none);
	auto work2 = node1.work_generate_blocking (send1->hash (), difficulty2 + 1, boost::none);
