...
TEST (bulk_pull, no_address)
{
	...
	auto connection (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*system.nodes[0], nano::socket::endpoint_type_t::server), system.nodes[0]));
...
TEST (bulk_pull, ascending_one_hash)
{
	...
	auto connection = std::make_shared<nano::tcp_server> (socket, system.nodes[0]);
	auto req = std::make_unique<nano::bulk_pull> (nano::dev::network_params.network);
...
TEST (bulk_pull, count_limit)
{
	...
	auto connection (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node0, nano::socket::endpoint_type_t::server), node0));
	auto req = std::make_unique<nano::bulk_pull> (nano::dev::network_params.network);
...
{
	{
		...
		{
			nano::test::system system (1);
			auto connection (std::make_shared<nano::tcp_server> (nullptr, system.nodes[0]));
...
TEST (frontier_req, count)
{
	...
	auto connection (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	auto req = std::make_unique<nano::frontier_req> (nano::dev::network_params.network);
	req->start.clear ();
	req->age = std::numeric_limits<decltype (req->age)>::max ();
	req->count = 1;
...
TEST (frontier_req, time_bound)
{
	...
	auto connection2 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*system.nodes[0], nano::socket::endpoint_type_t::server), system.nodes[0]));
...
TEST (frontier_req, confirmed_frontier)
{
	...
	auto connection2 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	auto req2 = std::make_unique<nano::frontier_req> (nano::dev::network_params.network);
	...
	auto connection3 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	...
	auto connection4 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	...
	auto connection5 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	...
	auto connection6 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
	...
	auto connection7 (std::make_shared<nano::tcp_server> (std::make_shared<nano::socket> (*node1, nano::socket::endpoint_type_t::server), node1));
