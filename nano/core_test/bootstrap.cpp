...
TEST (bootstrap_processor, lazy_hash_pruning)
{
	...
	nano::test::blocks_confirm (system, *node1, { send1, receive1, change1, change2 }, true);
...
TEST (bootstrap_processor, lazy_pruning_missing_block)
{
	...
	// Confirm last block to prune previous
	nano::test::blocks_confirm (system, *node1, { send1, send2, open, state_open }, true);
...
TEST (frontier_req, confirmed_frontier)
{
	...
	nano::test::blocks_confirm (system, *node1, { send1, receive1 }, true);
	...
	nano::test::blocks_confirm (system, *node1, { send2, receive2 }, true);
