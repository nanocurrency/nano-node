...
TEST (vote_processor, no_broadcast_local)
{
	...
	// Process a vote
	auto vote = std::make_shared<nano::vote> (nano::test_genesis_key.pub, nano::test_genesis_key.prv, node.timestamps.now (), std::vector<nano::block_hash>{ send->hash () });
	...
	// Process a vote
	auto vote2 = std::make_shared<nano::vote> (nano::test_genesis_key.pub, nano::test_genesis_key.prv, node.timestamps.now (), std::vector<nano::block_hash>{ send2->hash () });
	...
	// Process a vote
	auto vote3 = std::make_shared<nano::vote> (nano::test_genesis_key.pub, nano::test_genesis_key.prv, node.timestamps.now (), std::vector<nano::block_hash>{ open->hash () });
