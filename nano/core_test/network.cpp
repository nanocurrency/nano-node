...
TEST (network, send_insufficient_work)
{
	...
	auto & node2 = *system.nodes[1];
	// Block zero work
	auto block1 (std::make_shared<nano::send_block> (0, 1, 20, nano::test_genesis_key.prv, nano::test_genesis_key.pub, 0));
	...
	auto block2 (std::make_shared<nano::send_block> (block1->hash (), 1, 20, nano::test_genesis_key.prv, nano::test_genesis_key.pub, system.work_generate_limited (block1->hash (), node1.network_params.network.publish_thresholds.epoch_2_receive, node1.network_params.network.publish_thresholds.epoch_1 - 1)));
	...
	auto block3 (std::make_shared<nano::send_block> (block2->hash (), 1, 20, nano::test_genesis_key.prv, nano::test_genesis_key.pub, *system.work.generate (block2->hash (), node1.network_params.network.publish_thresholds.epoch_2)));
